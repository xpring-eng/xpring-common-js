 ...
 * @param {!proto.FiatAmount} msg The msg instance to transform.
 * @return {!Object}
 ...
 * @param {!proto.FiatAmount} msg The message object to deserialize into.
...
proto.FiatAmount.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = /** @type {!proto.FiatAmount.Currency} */ (reader.readEnum());
 ...
 * @param {!proto.FiatAmount} message
 ...
 * @return {!proto.FiatAmount.Currency}
 */
proto.FiatAmount.prototype.getCurrency = function() {
  return /** @type {!proto.FiatAmount.Currency} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};


/** @param {!proto.FiatAmount.Currency} value */
